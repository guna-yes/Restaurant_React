            ...
            <div>
                <Navbar dark expand="md">
                    ...
                    <div className="container">
                        ...
                        <NavbarBrand className="mr-auto" href="/"><img src='assets/images/logo.png' height="30" width="41" alt='Ristorante Con Fusion' />Restaurant</NavbarBrand>
                     ...
                     <Nav className="mr-auto" navbar>
                                <NavItem>
                                    <Button outline onClick={this.toggleModal} className="bg-light"><span className="fa fa-sign-in fa-lg"></span> Login</Button>
                                </NavItem>
                            </Nav>
                </Navbar>
                <Jumbotron>
